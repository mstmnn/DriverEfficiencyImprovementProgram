# database/drivers_basedata_arch_models.py
from database import db
from sqlalchemy import func

class TripBaseDataArch(db.Model):
    __tablename__ = 'trip_base_data_arch'
    __bind_key__ = 'drivers_base_data_arch'
    
    id = db.Column(db.Integer, primary_key=True)
    vehicle = db.Column(db.String(255))
    # Entferne den ForeignKey – nur als Integer speichern
    ...
    def __repr__(self):
        return f'<TripBaseDataArch {self.id} (vehicle={self.vehicle}, driver={self.driver_id})>'
